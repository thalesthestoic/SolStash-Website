...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: CtzKXifWMxjU12/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__rreSa)}
      >
        <div className={classNames(defaultcss.all, sty.box___8Neh)}>
          <div className={classNames(defaultcss.all, sty.box__vUi53)}>
            {p.renderPlasmicSlot({
