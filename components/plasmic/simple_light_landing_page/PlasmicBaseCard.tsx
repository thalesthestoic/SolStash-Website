...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: Lym6NaHNyX1wy6/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__y0TGg, {
          [sty.box__long__y0TGgblToY]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__k6OjB, {
            [sty.box__long__k6OjBblToY]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__oGnvg)}
                role={"img"}
              />
            ),
