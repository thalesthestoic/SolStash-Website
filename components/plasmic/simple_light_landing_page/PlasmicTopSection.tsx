...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: Z7WsHACddpdNH/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___26Cip)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__d7Jwl)}
        >
          <div className={classNames(defaultcss.all, sty.box__d393K)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___4Aphn)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__t4SRa)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__floaC)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__u5Yhi)}>
          <img
