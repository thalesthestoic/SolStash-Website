...
import * as sty from "./PlasmicLinkButton.module.css"; // plasmic-import: b9mdlhA0IcJ3A/css
  ...
  return (
    <p.PlasmicLink
      ...
      className={classNames(defaultcss.all, projectcss.root_reset, sty.root, {
        [sty.root__type_outlineBlack2]: hasVariant(
          variants,
          "type",
          "outlineBlack2"
        ),
        [sty.root__type_outlineBlack]: hasVariant(
          variants,
          "type",
          "outlineBlack"
        ),
    ...
    >
      {p.renderPlasmicSlot({
        ...
        className: classNames(sty.slotText, {
          [sty.slotText__type_outlineBlack2]: hasVariant(
            variants,
            "type",
            "outlineBlack2"
          ),
          [sty.slotText__type_outlineBlack]: hasVariant(
            variants,
            "type",
            "outlineBlack"
          ),
