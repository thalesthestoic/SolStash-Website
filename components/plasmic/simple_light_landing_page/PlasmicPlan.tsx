...
import BaseCard from "../../BaseCard"; // plasmic-import: Lym6NaHNyX1wy6/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: KFbMvQiTPR1iAn/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__kpHbQ)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__uhl9W)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__vnYlO)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__hcs7B)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__nnN0C)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__jmOnj)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.box__zt4MQ)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
